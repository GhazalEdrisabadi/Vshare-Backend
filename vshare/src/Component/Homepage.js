        ...
        $(document).ready(function () {
                ...
                $(".addbtn").click(function () {
                    ...
                    var settings = {
                        ...
                        "url": "http://localhost:8000/user/" + member + "",
                        ...
                        success: function () {
                            var settings = {
                                ...
                                "url": "http://localhost:8000/group/add_member/",
                ...
                var settings = {
                    ...
                    "url": "http://localhost:8000/group/owned_groups/",
                ...
                $('.modal2').mouseenter(function () {
                    ...
                    var settings = {
                        ...
                        "url": "http://localhost:8000/groups/" + gpid + "/",
                ...
                $('.dltyes').click(function () {
                    ...
                    if (localresponse.created_by == window.localStorage.getItem('username')) {
                        ...
                        var settings = {
                            ...
                            "url": "http://localhost:8000/group/" + gpid + "/leave/",
                            ...
                            success: function () {
                                ...
                                var settings = {
                                    ...
                                    "url": "http://localhost:8000/group/" + gpid + "/permissions/?member=" + window.localStorage.getItem('username') + "",
                ...
                var settings = {
                    ...
                    "url": "http://localhost:8000/group/joined_groups/",
                ...
                $.ajax(settings).done(function (response) {
                    for (var counter = 0; counter < response.length; counter++) {
                        ...
                        var settings2 = {
                            ...
                            "url": "http://localhost:8000/groups/" + gpid2 + "/",
