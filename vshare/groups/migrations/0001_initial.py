    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[(groups.models.StatusChoice['state0'], 'video was not selected by owner'), (groups.models.StatusChoice['state1'], 'video validation is checking'), (groups.models.StatusChoice['state2'], 'video is playing')], default=groups.models.StatusChoice['state0'], max_length=50)),
