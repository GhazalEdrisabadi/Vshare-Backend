    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('privacy', models.PositiveSmallIntegerField(choices=[(0, 'Every body can see it and join'), (1, 'Semi Private, everybody can see it but needs acceptance to join'), (2, 'Fully private, no one can see it and can only join it via invitation')], default=0)),
